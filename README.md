...
1. **Configurar o repositório público e o arquivo README.md**
   - i. Utilizar o editor web GitHub.dev para realizar edições rápidas no navegador.
   - ii. Garantir que o repositório esteja configurado como público para visualização da comunidade.
2. **Praticar a sintaxe de formatação com Markdown**
   - i. Organizar o texto de forma estruturada usando títulos, subtítulos e listas.
...
4. **Simular colaboração em equipe no repositório**
   - i. Convidar um colaborador (ou conta secundária) para participar do projeto.
   - ii. Realizar o clone do projeto localmente para simular o fluxo de trabalho de múltiplos desenvolvedores.
5. **Dominar o fluxo de trabalho com Issues e Pull Requests**
   - i. Criar e documentar issues para organizar as tarefas pendentes do projeto.
---
...
*   `git revert <id-da-commit>`: Reverte uma commit feita.
