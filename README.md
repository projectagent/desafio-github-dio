...
3. **Dominar os comandos essenciais do Git** [X]
   - i. Realizar alterações locais e preparar os arquivos usando o comando `git add`. [X]
   - ii. Salvar o progresso com mensagens de commit claras e enviar as alterações com `git push`. [X]
...
5. **Dominar o fluxo de trabalho com Issues e Pull Requests** [X]
   - i. Criar e documentar issues para organizar as tarefas pendentes do projeto.
6. **Adicionar os principais comandos GIT** [X]
   - i . Criar uma lista dos principais comandos que são utilizados no dia-a-dia. [X]
---
